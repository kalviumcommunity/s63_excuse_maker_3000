...
const landingPage = () => {
  return (
    <div className="landing-container">
      <h1>Welcome to the Excuse Maker 3000 🙇‍♂️</h1>
      <p>Introducing the Excuse Maker 3000™—the revolutionary AI-powered tool that generates top-tier excuses faster than you can say, “Its not my fault!” Whether youre dodging deadlines, bailing on plans, or just need a creative way to explain why your code still isn’t working, this state-of-the-art system has you covered.
